...
//#region ../../../2-sql/2-authoring/contract-psl/dist/interpreter-CZ_iVQV4.mjs
...
function interpretPslDocumentToSqlContract(input) {
	...
	for (const variantName of stiVariantNames) {
		...
		const baseDecl = baseDeclarations.get(variantName);
		invariant(baseDecl !== void 0, `stiVariantNames is derived from baseDeclarations.keys(), so "${variantName}" must have a base declaration`);
