...
import { t as postgresTargetDescriptorMeta } from "./descriptor-meta-D41CePyY-B0L9RIgT.mjs";
...
import { n as contractToPostgresDatabaseSchemaNode, r as diffPostgresSchema } from "./diff-database-schema-C9UxdmYu-BzQjQb1e.mjs";
import { t as PostgresContractSerializer } from "./postgres-contract-view-dWcpuV6T-CJPsHGox.mjs";
...
function buildPolicyBlocks(policiesByTable, modelNameMap, reservedHeads = /* @__PURE__ */ new Set()) {
	...
	for (const { policy, tableName } of all) {
		...
		if (badRole !== void 0) {
			...
			notes.push(`// prisma: skipped policy "${policy.name}": role "${badRole}" is not a valid PSL identifier and role references cannot be escaped`);
...
//# sourceMappingURL=control-BF220oqr.mjs.map