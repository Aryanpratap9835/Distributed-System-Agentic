...
export type StorageHash =
  StorageHashBase<'90ee779d24243e960d2894c949352d9c626fdad2f88861f587860d6439c41fab'>;
export type ExecutionHash =
  ExecutionHashBase<'22421469976de487ce342f6136aa29a4702046a77c711fdbf013f569ee5b89a8'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Job: {
      ...
      readonly workerId: CodecTypes['pg/uuid@1']['output'] | null;
    ...
    readonly worker: {
      ...
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly status: CodecTypes['pg/text@1']['output'];
      readonly lastHeartbeat: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly Job: {
      ...
      readonly workerId: CodecTypes['pg/uuid@1']['input'] | null;
    ...
    readonly worker: {
      ...
      readonly name: CodecTypes['pg/text@1']['input'];
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly lastHeartbeat: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
  };
};
...
export namespace Models {
  export type public_Job = {
    ...
    workerId: CodecTypes['pg/uuid@1']['output'] | null;
  ...
  export type public_worker = {
    ...
    name: CodecTypes['pg/text@1']['output'];
    status: CodecTypes['pg/text@1']['output'];
    lastHeartbeat: CodecTypes['pg/timestamptz-temporal@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    readonly [RelationKeys]?: never;
  };
}
...
> & {
  ...
  readonly roots: {
    ...
    readonly workers: { readonly namespace: 'public' & NamespaceId; readonly model: 'worker' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
